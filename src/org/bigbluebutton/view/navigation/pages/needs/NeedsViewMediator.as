package org.bigbluebutton.view.navigation.pages.needs {
	...
	public class NeedsViewMediator extends Mediator {
		
		[Inject]
		public var view:INeedsView;
		...
		override public function initialize():void {
			...
			FlexGlobals.topLevelApplication.pageName.text = "会议需求";//ResourceManager.getInstance().getString('resources', 'profile.status');
