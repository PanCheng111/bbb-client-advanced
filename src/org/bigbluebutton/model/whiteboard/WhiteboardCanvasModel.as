...
package org.bigbluebutton.model.whiteboard
{
  ...
  public class WhiteboardCanvasModel {
    public var whiteboardModel:WhiteboardModel = new WhiteboardModel(new EventDispatcher());
    private var _wbCanvas:WhiteboardCanvas;	      
    private var drawListeners:Array = new Array();
    public var wbTool:WhiteboardTool = new WhiteboardTool();
    private var shapeFactory:ShapeFactory = new ShapeFactory();
    public var idGenerator:AnnotationIDGenerator = new AnnotationIDGenerator();
